"""Startup bootstrap and legacy runtime maintenance helpers.

This module keeps the temporary runtime migration/backfill logic out of
`main.py` while the project progressively moves structural changes to Alembic.
"""
