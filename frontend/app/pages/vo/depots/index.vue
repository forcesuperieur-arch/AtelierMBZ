  ...
  <div>
    ...
    <PitCard class="bg-white">
      <div class="vo-filters">
        <PitInput v-model="search" placeholder="Plaque, marque, modèle, déposant..." />
      ...
      <PitTable v-else :data="filteredDepots" :columns="columns" :loading="voStore.loading" sticky>
        ...
        <template #actions-cell="{ row }">
          <div class="vo-actions">
            ...
            <PitButton v-if="row.original.status === 'actif'"  class="vo-link-btn" color="primary" is-warning>Vendre</PitButton>
...
definePageMeta({
  layout: 'default', title: 'Dépôts VO' })
