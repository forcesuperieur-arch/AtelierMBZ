  ...
  <div class="sig-overlay" role="dialog" aria-modal="true" aria-label="Signature" @click.self="$emit('close')">
    <div class="sig-modal">
      ...
      <div class="sig-actions">
        <button class="btn btn-ghost sig-btn" type="button" :disabled="saving" @click="$emit('close')">Annuler</button>
        <button class="btn btn-ghost sig-btn" type="button" :disabled="saving || !hasDrawn" @click="clearSignature">Effacer</button>
        <button class="btn btn-primary sig-btn" type="button" :disabled="saving || !hasDrawn" @click="confirm">
