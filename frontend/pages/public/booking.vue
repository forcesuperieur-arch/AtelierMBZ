    ...
    <div style="margin-bottom:18px;padding:14px;border:1px solid var(--border-2);border-radius:12px;background:var(--overlay-soft);">
      ...
      <div v-if="atelierOptions.length > 1">
        <select
          ...
          style="width:100%;padding:10px 14px;background:var(--surface-1);border:1px solid var(--border-2);border-radius:10px;color:var(--content-1);font-size:14px;font-family:inherit;"
        >
      ...
      <div style="padding:14px;border:1px solid var(--border-2);border-radius:12px;background:var(--overlay-soft);">
        ...
        <div style="display:flex;gap:10px;">
          <input
            ...
            style="flex:1;padding:10px 14px;background:var(--surface-1);border:1px solid var(--border-2);border-radius:10px;color:var(--content-1);font-size:14px;font-family:inherit;"
        ...
        <div v-if="showManualVehicle" style="margin-top:16px;">
          ...
          <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:12px;">
            <div style="position:relative;">
              ...
              <input v-model="form.vehicule_marque" type="text" placeholder="Ex: KAWASAKI" style="width:100%;padding:8px 12px;background:var(--surface-1);border:1px solid var(--border-2);border-radius:10px;color:var(--content-1);font-size:14px;font-family:inherit;" @input="onMarqueInput" @blur="deferHideMarqueSuggestions" />
            ...
            <div style="position:relative;">
              ...
              <input v-model="form.vehicule_modele" type="text" placeholder="Ex: Z900" style="width:100%;padding:8px 12px;background:var(--surface-1);border:1px solid var(--border-2);border-radius:10px;color:var(--content-1);font-size:14px;font-family:inherit;" @input="onModeleInput" @blur="deferHideModeleSuggestions" />
            ...
            <div>
              ...
              <input v-model="form.vehicule_plaque" type="text" placeholder="AB-123-CD" style="width:100%;padding:8px 12px;background:var(--surface-1);border:1px solid var(--border-2);border-radius:10px;color:var(--content-1);font-size:14px;font-family:inherit;" @blur="normalizePlateField" />
            </div>
            <div>
              ...
              <input v-model="form.vehicule_annee" type="number" placeholder="2024" style="width:100%;padding:8px 12px;background:var(--surface-1);border:1px solid var(--border-2);border-radius:10px;color:var(--content-1);font-size:14px;font-family:inherit;" />
            </div>
            <div>
              ...
              <input v-model="form.vehicule_cylindree" type="number" placeholder="900" style="width:100%;padding:8px 12px;background:var(--surface-1);border:1px solid var(--border-2);border-radius:10px;color:var(--content-1);font-size:14px;font-family:inherit;" />
            </div>
            <div>
              ...
              <select v-model="form.vehicule_type" style="width:100%;padding:8px 12px;background:var(--surface-1);border:1px solid var(--border-2);border-radius:10px;color:var(--content-1);font-size:14px;font-family:inherit;">
      ...
      <div style="padding:14px;border:1px solid var(--border-2);border-radius:12px;background:var(--overlay-soft);">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:12px;">
          <div>
            ...
            <input v-model="form.client_prenom" type="text" required style="width:100%;padding:8px 12px;background:var(--surface-1);border:1px solid var(--border-2);border-radius:10px;color:var(--content-1);font-size:14px;font-family:inherit;" />
          </div>
          <div>
            ...
            <input v-model="form.client_nom" type="text" required style="width:100%;padding:8px 12px;background:var(--surface-1);border:1px solid var(--border-2);border-radius:10px;color:var(--content-1);font-size:14px;font-family:inherit;" />
          </div>
          <div>
            ...
            <input v-model="form.client_telephone" type="tel" required style="width:100%;padding:8px 12px;background:var(--surface-1);border:1px solid var(--border-2);border-radius:10px;color:var(--content-1);font-size:14px;font-family:inherit;" />
          </div>
          <div>
            ...
            <input v-model="form.client_email" type="email" required style="width:100%;padding:8px 12px;background:var(--surface-1);border:1px solid var(--border-2);border-radius:10px;color:var(--content-1);font-size:14px;font-family:inherit;" />
          </div>
        </div>
        ...
        <div style="margin-top:16px;">
          ...
          <textarea v-model="form.description_probleme" rows="3" placeholder="Exemple : vidange, frein avant bruyant, révision avant départ…" style="width:100%;padding:10px 14px;background:var(--surface-1);border:1px solid var(--border-2);border-radius:10px;color:var(--content-1);font-size:14px;font-family:inherit;resize:vertical;"></textarea>
        </div>
      </div>
