...
- [V.2026.04.14-1] | [2026-04-14] | [Refactor API Modulaires] | [Decoupage de `app/services/email_service.py`, `app/config_api.py` et `app/statistiques.py` en modules metier compatibles, avec conservation des prefixes/routes existants via fichiers agregateurs et passage de tous les nouveaux fichiers Python concernes sous la limite de 200 lignes.]
