<template>
  <div>
    ...
    <div v-if="stats" class="vo-stats-grid">
      <StatsCard title="En stock" :value="stats.en_stock" icon="i-heroicons-shopping-bag" />
      <StatsCard title="Vendus ce mois" :value="stats.vendus" icon="i-heroicons-check-circle" />
      <StatsCard title="Dépôts actifs" :value="stats.depots_actifs" icon="i-heroicons-clipboard-document-list" />
      <StatsCard title="Alertes dossiers" :value="stats.alerts_count" icon="i-heroicons-exclamation-triangle" :color="stats.alerts_count > 0 ? 'warning' : 'primary'" />
    </div>
